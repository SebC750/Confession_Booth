...
const ConfessionForm = () => {
    ...
    return (
        <div>
            <Link href="/" className="font-bold text-yellow-500 text-3xl transition-all duration-200 hover:pl-3"> <i className="bi bi-arrow-left font-bold text-3xl"></i> Back to Confessions</Link>
            <div className="flex justify-center">
                <div className="p-4 rounded-xl fade-in-animation w-auto lg:w-[40%]">
